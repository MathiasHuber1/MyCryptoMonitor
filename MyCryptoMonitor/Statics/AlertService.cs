...
namespace MyCryptoMonitor.Statics
{
    public class AlertService
    {
        ...
        private static readonly string FILENAME = UserConfigService.DataFolder + "Alert.config";
        ...
        public static void SendAlert(List<AlertDataSource> alerts)
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                {
                    var condition = alert.LastOperator == Operators.GreaterThan ? "greater than" : alert.Operator == Operators.GreaterThan ? "greater than" : "less than";
