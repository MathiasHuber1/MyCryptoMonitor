            ...
            switch (step)
            {
                case 0:
                    ...
                    lblInfo.Text = "Thank you for using My Crypto Monitor, I hope you enjoy it!\r\n\r\n" +
                        ...
                        "\u2022 An API key is necessary for CoinMarketCap. Please create an account and insert yours in the text box called \"CoinMarketcap API key\".\r\n" +
                        "\u2022 On \"Number of currencies to request to CoinMarketCap\", please insert how many you want to request. If you enter a number and the coin you want to add is ranked at a higher number, you won't find it. This was decided because CoinMarketCap API has a limit of request per day, and every 100 coins it consumes one credit.";
                ...
                case 3:
                    ...
                    lblInfo.Text = "\u2022 Accessed from the main screen via Save > Manage Portfolios Menu\r\n\r\n" +
