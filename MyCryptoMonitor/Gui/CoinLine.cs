...
namespace MyCryptoMonitor.Gui
{
    public sealed class CoinLine : IDisposable
    {
        ...
        private TextBox boughtTextBox;
        public TextBox BoughtTextBox { get => boughtTextBox; set => boughtTextBox = value; }
        ...
        public CoinLine(string coinName, int coinIndex, int lineIndex, int formWidth)
        {
            ...
            Table.Location = new Point(0, 150 + 25 * lineIndex);
        ...
        private void Input_TextChanged(object sender, EventArgs e)
        {
            ...
            MainService.LinesNeedUpdating = true;
        }

        private void Label_TextChanged(object sender, EventArgs e)
        {
            var label = (Label)sender;
            var changePercent = label.Text.Replace("%", string.Empty).Replace(MainService.CurrencySymbol, string.Empty).ConvertToDecimal();
